...
function logoEmpresa(e) {
  if (e.theme === "oba") {
    return `<svg class="emp-logo-svg emp-logo-oba" viewBox="0 0 491 118" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M81.6518 18.3739L93.8053 8.98348C85.6639 3.81231 75.9919 0.775477 65.5397 0.762302C50.9414 0.745834 37.5656 6.63833 27.8769 16.3351C35.7169 12.0961 44.4779 9.53024 53.8484 9.53683C64.3039 9.54671 73.5137 13.1995 81.6551 18.3706" fill="currentColor"/>
      <path d="M2.80707e-05 63.3252C-0.0301129 93.3477 24.2166 117.639 53.7213 117.669C68.477 117.688 81.6955 111.641 91.3941 101.941C83.7015 106.328 74.7865 107.834 65.416 107.83C35.9113 107.794 14.116 84.4151 14.1529 54.5375C14.1696 39.3732 18.1784 26.1883 27.8771 16.34C11.5675 25.5757 0.02682 42.9996 2.80707e-05 63.3252Z" fill="currentColor"/>
      <path d="M205.176 11.2092L217.166 3.03415H141.565L129.603 11.2092V115.393H205.052L217.045 107.218H144.512V58.3657H198.515L210.508 50.1807H144.512V11.2092H205.176Z" fill="currentColor"/>
      <path d="M312.415 50.0457H275.984L264.705 58.066V11.2059H297.562C313.379 11.2257 322.894 20.2044 322.88 33.5441C322.87 40.0657 320.861 45.9681 316.869 50.3652C315.181 50.0556 314.106 50.0424 312.418 50.0424M317.18 50.3652C327.468 47.19 336.544 37.7996 336.554 26.5844C336.568 12.9417 324.598 3.05391 308.928 3.03415H261.748L249.792 11.2059V115.393H311.263L323.259 107.218H264.708V58.2175L300.881 58.2306C327.763 58.2636 338.637 86.9224 323.259 107.222C334.475 102.683 344.321 91.9322 344.334 79.3534C344.354 64.3471 332.532 52.6576 317.184 50.3718" fill="currentColor"/>
      <path d="M436.281 0.762318C421.545 0.742555 408.189 6.64164 398.511 16.3187C406.19 11.938 415.088 9.67188 424.603 9.68177C454.218 9.71141 477.37 33.8216 477.333 63.6596C477.313 78.8042 471.931 92.2789 462.098 102.107C478.679 92.8882 490.977 75.1811 491 54.8916C491.033 25.0602 465.893 0.798549 436.281 0.762318Z" fill="currentColor"/>
  ...
  if (e.theme === "ene") {
    return `<svg class="emp-logo-svg emp-logo-ene" viewBox="0 0 260 90" fill="none" xmlns="http://www.w3.org/2000/svg">
      <text x="50%" y="78" text-anchor="middle" font-family="Arial Rounded MT Bold, Arial, sans-serif" font-size="88" font-weight="900" fill="#7a3e28" letter-spacing="-2">eñe</text>
    </svg>`;
  }
  if (e.theme === "candomo") {
  ...
  if (e.theme === "canitas") {
    return `<div class="emp-logo-canitas">CAÑITAS</div>`;
  }
